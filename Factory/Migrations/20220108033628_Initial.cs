        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MachineId = table.Column<int>(type: "int", nullable: false),
                    EngineerId = table.Column<int>(type: "int", nullable: false),
                    EngineerMachineId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EngineerMachine", x => x.EngineerMachineId);
                    table.ForeignKey(
                        name: "FK_EngineerMachine_EngineerMachine_EngineerMachineId1",
                        column: x => x.EngineerMachineId1,
                        principalTable: "EngineerMachine",
                        principalColumn: "EngineerMachineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EngineerMachine_EngineerMachineId1",
                table: "EngineerMachine",
                column: "EngineerMachineId1");
